<template>
  ...
  @dragstart="drag" @drop="drop" @dragover.prevent>
  </div>
</template>
...
export default {
  ...
  methods:{
    ...
    drag: function(event) {
      ...
      //   'position: absolute; display: block; top: 0; left: 0; width: 10px; height: 10px; background-color:red' );
      // // add it to the document
      // document.body.appendChild(dragImgEl);
      // event.dataTransfer.setDragImage(dragImgEl, 10, 10)
    ...
    dragPrevent: function() {
      console.log("dragPrevent");
    },
  }
}
